...
//            }
    ...
    companion object {
        ...
        val dictionary = mapOf(
            "Авдотка" to R.id.word1,
            "Бабакотии" to R.id.word2,
            "Варакушка" to R.id.word3,
